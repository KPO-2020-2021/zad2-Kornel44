...
${TBIN}/test_2: ${TBIN} ${OBJ}/LZespolona.o ${OBJ}/WyrazenieZesp.o
	g++ -o ${TESTS}/bin/test_2 ${FLAGS} -I${TESTS}/doctest ${TESTS}/test2.cpp ${OBJ}/WyrazenieZesp.o ${OBJ}/LZespolona.o

${TBIN}/test_3: ${TBIN} ${OBJ}/Statystyki.o
	g++ -o ${TESTS}/bin/test_3 ${FLAGS} -I${TESTS}/doctest ${TESTS}/test3.cpp ${OBJ}/Statystyki.o
